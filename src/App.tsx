      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12 space-y-16 md:space-y-20">
        ...
        <section className="flex flex-row items-center justify-between gap-4 pt-4 md:pt-6">
          <div className="space-y-4 max-w-[70%] md:max-w-2xl flex-grow">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-2 md:gap-3 pt-1 md:pt-2 w-full">
              <div className="inline-flex items-center gap-2 bg-white border border-slate-200 px-2.5 py-1.5 md:px-3 md:py-2 rounded-lg text-xs md:text-sm font-medium text-slate-700 shadow-sm w-full sm:w-auto overflow-x-auto scrollbar-none">
              ...
              <div className="flex flex-wrap items-center gap-1.5 w-full sm:w-auto">
                <a href="https://github.com/Yash16Gupta" target="_blank" rel="noreferrer" className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 bg-white border border-slate-200 px-2.5 py-1.5 rounded-lg text-[11px] md:text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition duration-150 shadow-sm whitespace-nowrap">
                ...
                <a href="https://www.linkedin.com/in/yashgupta1397" target="_blank" rel="noreferrer" className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 bg-white border border-slate-200 px-2.5 py-1.5 rounded-lg text-[11px] md:text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition duration-150 shadow-sm whitespace-nowrap">
                ...
                <a href="https://scholar.google.com/citations?user=zyANulwAAAAJ&hl=en" target="_blank" rel="noreferrer" className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 bg-white border border-slate-200 px-2.5 py-1.5 rounded-lg text-[11px] md:text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition duration-150 shadow-sm whitespace-nowrap">
